        ...
        <section className="w-full h-[1000px] xl:h-[800px] 2xl:h-[800px] bg-black text-white relative flex flex-col border-3 border-l-transparent border-r-transparent border-t-[#88664d] border-b-[#88664d]">
            ...
            <div className="w-full h-1/2 relative">
                <div className="flex flex-row w-full h-[200px]">
                    <ul className="flex flex-row w-full pl-10 pr-10 gap-x-3">
                ...
                <div className="w-[90vw] h-[100px] bg-black mt-15 mx-auto flex justify-center items-center">
                    <h1 className="text-center text-[30px]">SVE MOLERSKE RADOVE U NOVOM SADU I OKOLINI IZVODIMO PO DOGOVORENOJ CENI, BEZ SKRIVENIH TROŠKOVA</h1>
                </div>
            </div>
        </section>
    );
