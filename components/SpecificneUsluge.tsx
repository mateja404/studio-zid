            ...
            <div className="w-full h-1/2 relative">
                <div className="flex flex-col max-sm:-mt-80 sm:-mt-80 xl:flex-row xl:mt-[-100px] w-full h-[200px]">
                    <ul className="flex flex-col sm:gap-y-3 max-sm:gap-y-10 xl:flex-row w-full pl-10 pr-10 gap-x-3">
                        ...
                        <li className="flex flex-col gap-y-4 text-2xl"><span className="bg-black w-[40px] h-[40px] flex items-center justify-center rounded-full max-sm:hidden sm:hidden xl:flex"><MoveDownRight/></span>Uklanjanje postojećih slojeva (uključujući skidanje španskog zida)</li>
                        <li className="flex flex-col gap-y-4 text-2xl"><span className="bg-black w-[40px] h-[40px] flex items-center justify-center rounded-full max-sm:hidden sm:hidden xl:flex"><MoveDownRight/></span>Saveti i preporuke za kolege ukoliko su vam potrebni i drugi radovi</li>
                    </ul>
                </div>
