        ...
        <nav className="w-full h-[100px] bg-black fixed z-20 text-white">
            ...
            <div className="absolute my-10 md:right-10 lg:right-10 xl:right-20 2xl:right-30 2xl:flex xl:flex lg:flex md:flex sm:hidden max-sm:hidden flex">
                <ul className="flex flex-row justify-between gap-17">
                    <li className="relative"><Link className="text-[1rem] nav-item" href={"#about"} onClick={(e) => handleLinkClick(e, '#about')}>O nama</Link></li>
                    <li className="relative"><Link className="text-[1rem] nav-item" href={"#naseusluge"} onClick={(e) => handleLinkClick(e, '#naseusluge')}>Naše usluge</Link></li>
                    <li className="relative"><Link className="text-[1rem] nav-item" href={"#recenzije"} onClick={(e) => handleLinkClick(e, '#recenzije')}>Recenzije</Link></li>
                    <li className="relative"><Link className="text-[1rem] nav-item" href={"#specusluge"} onClick={(e) => handleLinkClick(e, '#specusluge')}>Specifične usluge</Link></li>
                </ul>
            </div>
