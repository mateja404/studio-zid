        ...
        <section className="w-full h-[1000px] md:hidden sm:hidden max-sm:hidden xl:h-[1000px] 2xl:h-[800px] bg-black text-white relative flex flex-col border-3 border-l-transparent border-r-transparent border-t-[#88664d] border-b-[#88664d]">
            ...
            <div className="w-full h-1/2 bg-black z-2">
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-x-1 -gap-y-2 -translate-y-[290px] place-items-center">
                    <Image src={gallery1} alt={"Galerija"} width={190}/>
                    <Image src={gallery2} alt={"Galerija"} width={190}/>
                    <Image src={gallery3} alt={"Galerija"} width={190}/>
                    <Image src={gallery4} alt={"Galerija"} width={190}/>
                    <Image src={gallery5} alt={"Galerija"} width={190}/>
                    <Image src={gallery6} alt={"Galerija"} width={190}/>
                    <Image src={gallery7} alt={"Galerija"} width={190}/>
                    <Image src={gallery8} alt={"Galerija"} width={190}/>
                </div>
            </div>
        </section>
    );
