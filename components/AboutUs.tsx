...
const AboutUs = () => {
    return (
        <section className="w-full h-[1500px] xl:h-[1000px] 2xl:h-[1000px] bg-black relative grid grid-cols-1 md:grid-cols-2 border-3 border-l-transparent border-r-transparent border-t-[#88664d] border-b-[#88664d]">
            <Image
                src={onamabg}
                alt={"O nama"}
            ...
            <div className="w-[100vw] flex h-[300px] z-2">
                <div className="flex justify-center items-center flex-col mx-auto xl:pl-5 xl:pr-5 2xl:pl-5 2xl:pr-5">
                    <ul className="flex flex-col gap-y-5 xl:gap-0 xl:flex-row 2xl:gap-0 2xl:flex-row">
            ...
            <div className="w-[100vw] flex h-[150px] z-2 absolute bottom-[20%] xl:bottom-0 2xl:bottom-0 mx-auto">
                <ul className="flex flex-col gap-y-5 xl:gap-0 xl:flex-row 2xl:gap-0 2xl:flex-row">
                    <li className="flex 2xl:inline-flex gap-x-4 text-white text-xl">
                        <MoveDownRight className="w-[30px] h-[30px] bg-slate-500/80 rounded-full p-1"/>
                        TRANSPARENTE CENE BEZ DODATNIH IZNENAĐENJA
