    ...
    return (
        <footer className="clear-both w-full h-[550px] max-sm:h-[1200px] relative flex flex-col">
            ...
            <div className="w-full md:w-1/2 h-[80%] absolute top-0 flex flex-col pl-10">
                ...
                <div className="absolute mt-100 xl:mt-85 max-sm:mt-135 md:bottom-0 w-full h-[100px] flex flex-col top-10 gap-y-2 md:flex-row md:items-center md:justify-center gap-x-10">
