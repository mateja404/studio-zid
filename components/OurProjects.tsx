...
const OurProjects = () => {
    return (
        <section className="w-full h-[1000px] xl:h-[800px] 2xl:h-[800px] bg-black text-white relative flex flex-col border-3 border-l-transparent border-r-transparent border-t-[#88664d] border-b-[#88664d]">
            <Image src={nasiprojekti} alt={"Naši projekti"} className="w-full h-full object-cover absolute top-0 left-0 z-0"/>
            <div className="w-full h-[70vw] flex items-center justify-center z-2">
                <h1 className="text-9xl text-black">Naši <br/> Projekti</h1>
            </div>
            <div className="w-full h-[30vw] flex items-center justify-center z-2">
                <div className="w-[90vw] h-[100px] mb-50 bg-[#b98d5e] flex items-center justify-center">
                    <ul className="flex flex-row gap-x-30">
                        ...
                        <li className="flex flex-row gap-x-3 text-2xl text-black"><span className="w-[40px] h-[40px] bg-black rounded-full flex items-center justify-center"><MoveDownRight className="text-[#b98d5e]"/></span>Zgrade u izgradnji</li>
                    </ul>
                </div>
            </div>
        </section>
